 ...
 * @export
 */
export const QueueInteriorApiAxiosParamCreator = function (
  ...
  return {
    ...
    queuesQueueIdGet: async (
      ...
      if (queueId === null || queueId === undefined) {
        throw new RequiredError(
          "queueId",
          "Required parameter queueId was null or undefined when calling queuesQueueIdGet."
        );
      }
      const localVarPath = `/queues/{queueId}`.replace(
        `{${"queueId"}}`,
    ...
    queuesStartPost: async (
      ...
      localVarRequestOptions.data = needsSerialization
        ? JSON.stringify(seatType !== undefined ? seatType : {})
        : seatType || "";
...
export const QueueInteriorApiFp = function (configuration?: Configuration) {
  return {
     ...
     * @throws {RequiredError}
     */
    async queuesQueueIdGet(
      queueId: number,
      options?: any
    ): Promise<
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<QueueInfo>
    > {
      const localVarAxiosArgs = await QueueInteriorApiAxiosParamCreator(
        configuration
      ).queuesQueueIdGet(queueId, options);
      return (
    ...
    async queuesStartPost(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string
      ) => AxiosPromise<Array<InlineResponse2013>>
    > {
      const localVarAxiosArgs = await QueueInteriorApiAxiosParamCreator(
        configuration
      ).queuesStartPost(seatType, options);
      return (
        axios: AxiosInstance = globalAxios,
        basePath: string = BASE_PATH
      ) => {
    ...
    > {
      const localVarAxiosArgs = await QueueInteriorApiAxiosParamCreator(
        configuration
      ).queuesStopPost(requestBody, options);
      return (
        axios: AxiosInstance = globalAxios,
        basePath: string = BASE_PATH
      ) => {
 ...
 * @export
 */
export const QueueInteriorApiFactory = function (
  configuration?: Configuration,
  basePath?: string,
  axios?: AxiosInstance
) {
  return {
    ...
    queuesQueueIdGet(queueId: number, options?: any): AxiosPromise<QueueInfo> {
      return QueueInteriorApiFp(configuration)
        .queuesQueueIdGet(queueId, options)
...
export class QueueInteriorApi extends BaseAPI {
  ...
  public queuesQueueIdGet(queueId: number, options?: any) {
    return QueueInteriorApiFp(this.configuration)
      .queuesQueueIdGet(queueId, options)
