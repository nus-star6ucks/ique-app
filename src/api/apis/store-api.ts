  ...
  return {
    ...
    storesStartPost: async (
      ...
      if (storeId === null || storeId === undefined) {
        throw new RequiredError(
          "storeId",
          "Required parameter storeId was null or undefined when calling storesStartPost."
        );
      }
    ...
    storesStopPost: async (
      ...
      if (storeId === null || storeId === undefined) {
        throw new RequiredError(
          "storeId",
          "Required parameter storeId was null or undefined when calling storesStopPost."
        );
      }
    ...
    storesStoreIdGet: async (
      ...
      if (storeId === null || storeId === undefined) {
        throw new RequiredError(
          "storeId",
          "Required parameter storeId was null or undefined when calling storesStoreIdGet."
        );
      }
      const localVarPath = `/stores/{storeId}`.replace(
        `{${"storeId"}}`,
...
export const StoreApiFp = function (configuration?: Configuration) {
  return {
    ...
    > {
      const localVarAxiosArgs = await StoreApiAxiosParamCreator(
        configuration
      ).storesDelete(id, options);
      return (
    ...
    > {
      const localVarAxiosArgs = await StoreApiAxiosParamCreator(
        configuration
      ).storesPost(inlineObject4, options);
      return (
        axios: AxiosInstance = globalAxios,
        basePath: string = BASE_PATH
      ) => {
    ...
    > {
      const localVarAxiosArgs = await StoreApiAxiosParamCreator(
        configuration
      ).storesPut(inlineObject3, options);
      return (
        axios: AxiosInstance = globalAxios,
        basePath: string = BASE_PATH
      ) => {
    ...
    > {
      const localVarAxiosArgs = await StoreApiAxiosParamCreator(
        configuration
      ).storesStartPost(storeId, options);
      return (
        axios: AxiosInstance = globalAxios,
        basePath: string = BASE_PATH
      ) => {
    ...
    > {
      const localVarAxiosArgs = await StoreApiAxiosParamCreator(
        configuration
      ).storesStopPost(storeId, options);
      return (
        axios: AxiosInstance = globalAxios,
        basePath: string = BASE_PATH
      ) => {
    ...
    > {
      const localVarAxiosArgs = await StoreApiAxiosParamCreator(
        configuration
      ).storesStoreIdGet(storeId, options);
      return (
        axios: AxiosInstance = globalAxios,
        basePath: string = BASE_PATH
      ) => {
...
export const StoreApiFactory = function (
  ...
  return {
    ...
    storesDelete(id: number, options?: any): AxiosPromise<object> {
      return StoreApiFp(configuration)
        .storesDelete(id, options)
