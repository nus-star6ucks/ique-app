...
<template>
  <Teleport to="#app">
    <Transition name="slide-fade">
      <div v-if="snackStore.snack" :class="`is-${snackStore.snack?.mode}`" class="flex p-4 mb-4 text-sm rounded-lg transition-all fixed top-20 min-w-90 shadow-md shadow-gray-200 left-1/2 transform -translate-x-1/2 z-50" role="alert">
        ...
        <div v-text="snackStore.snack?.message" />
      </div>
    </Transition>
  </Teleport>
</template>
