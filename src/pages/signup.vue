  ...
  <WithoutAuth>
    <div>
      <header class="flex items-center justify-between">
        ...
        <RouterLink to="/login" class="text-gray-800"> Login </RouterLink>
      </header>

      <form class="form-auth mt-24 space-y-16" @submit.prevent="onSubmit">
        <h2 class="font-semibold text-3xl pt-8">Join Us</h2>
        <div class="space-y-4">
          <div class="relative">
        ...
        <div>
          <button
            type="submit"
            class="text-center w-full bg-emerald-500 shadow-md shadow-emerald-500/40 text-white rounded-lg uppercase py-4"
          >
            Sign up
          </button>
        </div>
